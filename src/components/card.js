     ...
     return (
       ...
       <div className="cards__item card">
         <div className={`card__inner card__inner__mode_${this.state.theme} card__inner__shadow-${this.state.theme}`}>
            <Link key={country.ccn3} to={`/country/${country.name.common}`}>
               <div className="card__image-container">
                  <img className="card__image" src={country.flags.svg} alt={country.name.common}/>
               </div>

               <div className="card__description">
                <h3 className={`card__title cart__text__${this.state.theme}`}>{country.name.common}</h3>
